...
YOLOP = [
[24, 33, 42, 43],   #Det_out_idx, Da_Segout_idx, LL_Segout_idx, lanenet_out
[ -1, Focus, [3, 32, 3]],   #0
[ -1, Conv, [32, 64, 3, 2]],    #1
...
class MCnet(nn.Module):
    def __init__(self, block_cfg, **kwargs):
        ...
        for i, (from_, block, args) in enumerate(block_cfg[1:]):
            ...
            #if i == self.lanenet_out_idx: print("-------lanenet--------")
            block_ = block(*args)
    ...
    def forward(self, x):
        ...
        for i, block in enumerate(self.model):
            ...
            #try:
            #    print("idx = {},x.cuda? = {}".format(i,x.is_cuda))
            #except:
            #    print("idx = {},x.type = {}".format(i,type(x)))
